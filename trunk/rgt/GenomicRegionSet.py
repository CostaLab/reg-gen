...
class GenomicRegionSet:
    ...
    def get_genome_data(self,path=GenomeData.CHROMOSOME_SIZES, chrom_X=False, chrom_M=False):
    ...
    def random_regions(self, organism=GenomeData.CHROMOSOME_SIZES, total_size=None, multiply_factor=0, overlap_result=False, overlap_input=False, chrom_X=False, chrom_M=False):
