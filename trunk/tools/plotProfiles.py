...
bed.readBed(bedFile)
bed.extend(19500,19500) # size of the lamina border 

cov=CoverageSet(bed.name+"_"+basename(bamFile)[:-4],bed)
cov.coverageFromBam(bamFile,step=1000,window=1000) # size of the window 
...
cov2.coverageFromBam(bamFile2,step=1000,window=1000)
...
cov.coverageFromBam(bamFile3,step=1000,window=1000)
cov.normFPKM()
...
cov2.coverageFromBam(bamFile4,step=1000,window=1000)
...
cov.coverageFromBam(bamFile5,step=1000,window=1000)
cov.normFPKM()
...
cov2.coverageFromBam(bamFile6,step=1000,window=1000)
