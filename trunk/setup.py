...
"hint": (
  "rgt-hint",
  "rgt.HINT.Main:main",
  ['numpy>=1.4.1','scipy>=0.7.2','scikit-learn<=0.14','pysam>=0.7.5']
), 
"ODIN": (
  "rgt-ODIN",
  "rgt.ODIN.ODIN:main",
...
"fig": ["rgt_logo.gif","style.css","default_motif_logo.png","jquery-1.11.1.js","jquery.tablesorter.min.js","jquery.metadata.js"],
}
